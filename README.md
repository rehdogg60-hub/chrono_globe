...
Published by Reh Dogg Games Plus.
...
Use the GitHub Pages or static web-host link for previews and Ko-fi posts. The downloadable Ko-fi package is:
...
ChronoGlobe is provided as a static browser game by Reh Dogg Games Plus. Event summaries are educational overview text and should be reviewed by the publisher before commercial release if exact denominational, historical, or academic wording is important.
